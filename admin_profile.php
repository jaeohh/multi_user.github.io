...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold mb-6 text-center">Admin Profile</h2>
        <form method="POST">
            <label class="block mb-2 text-sm">First Name</label>
            <input type="text" name="first_name" value="<?= $admin['first_name'] ?>" class="w-full p-2 mb-3 border rounded" readonly required>

            <label class="block mb-2 text-sm">Last Name</label>
            <input type="text" name="last_name" value="<?= $admin['last_name'] ?>" class="w-full p-2 mb-3 border rounded" readonly required>

            <label class="block mb-2 text-sm">Email</label>
            <input type="email" name="email" value="<?= $admin['email'] ?>" class="w-full p-2 mb-3 border rounded" readonly required>
