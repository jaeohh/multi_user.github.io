...
<div class="hamburger" onclick="toggleSidebar()">
  ...
  <div class="sidebar">
    <div>
      <h1><i class="fas fa-user"></i> Barista</h1>
      <ul>
        <br>
        <li class="active" data-target="dashboard"><i class="fa fa-home"></i> Dashboard</li>
        <li data-target="orders"><i class="fa fa-box"></i> Manage Orders</li>
        <li data-target="coffee"><i class="fa fa-coffee"></i> Manage Complete</li>
        <li data-target="staff"><i class="fa fa-users"></i> Manage Profile</li>
        <li data-target="inventory"><i class="fa fa-cogs"></i> Inventory</li>
      </ul>
    </div>
      ...
      item.addEventListener('click', function () {
        ...
        if (target === 'dashboard') {
          ...
          const pageMap = {
            ...
            coffee: "manage_orderss.php",
            staff: "manage_staff.php",
